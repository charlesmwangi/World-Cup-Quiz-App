...
// Check which radio button was clicked for question 8
    ...
    public void submitAnswers(View view) {
        ...
        //get input from the support team EditText field and convert it to allCaps
        ...
        String results = "Hello " + name + ". Thank you for answering the world cup questions.";
        results += "\nYou scored " + score + " out of 12";

        //check the answer to the last question
        String winner = "FRANCE";
        if (support.equals(winner)) {
            results += "\nCongratulations.Your team " + support + " won the 2018 world cup";
        } else {

            results += "\nOops.Sorry your team " + support + " didn't win the tittle.Best of luck next time";
        }

        //make the score text view visible and display results
        TextView viewScore = (TextView) findViewById(R.id.score);
        viewScore.setVisibility(View.VISIBLE);
        viewScore.setText(results);
    ...
    public void Retry(View view) {
        ...
        //Make answers and score and retry invisible and make submit visible
        Button viewAnswers = (Button) findViewById(R.id.answers);
